...
# OCRganizer Preview Script
# Shows what would be organized without actually moving files
...
# Run the CLI tool in dry-run mode (it will handle all the beautiful output)
python cli.py \
    --input "$INPUT_DIR" \
    --output "$OUTPUT_DIR" \
    --dry-run \
    --json-output "preview_results.json"
